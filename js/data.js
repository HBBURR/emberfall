...
const ITEMS = {
  ...
  frost_mail:  { name: 'Glacier Mail',    icon: '❄️', slot: 'armor', rar: 3, def: 16, hp: 240, set: 'frost', price: 2400, desc: '+16 Defense, +240 Health. Cold-forged in Frostpeak.' },
  hollow_plate:{ name: 'Plate of the Hollow King', icon: '🖤', slot: 'armor', rar: 3, def: 26, hp: 520, set: 'hollow', price: 9999, desc: '+26 Defense, +520 Health. It weighs nothing at all.' },
  // helms (def, hp)
  ...
  frost_helm:  { name: 'Rimehorn Helm',   icon: '🦌', slot: 'helm', rar: 3, def: 10, hp: 160, set: 'frost', price: 2400, desc: '+10 Defense, +160 Health.' },
  hollow_helm: { name: 'Hollow Visage',   icon: '🎭', slot: 'helm', rar: 3, def: 17, hp: 340, set: 'hollow', price: 9999, desc: '+17 Defense, +340 Health. It has no eye holes. It does not need them.' },
  // boots (spd, def)
  ...
  frost_treads:{ name: 'Glacier Treads',  icon: '⛸️', slot: 'boots', rar: 3, spd: 26, def: 8, set: 'frost', price: 2400, desc: '+26 Move speed, +8 Defense.' },
  hollow_striders:{name:'Voidstep Boots', icon: '🌫️', slot: 'boots', rar: 3, spd: 32, def: 12, set: 'hollow', price: 9999, desc: '+32 Move speed, +12 Defense. Your footsteps make no sound.' },
  // trinkets
